...
'#Region "#code"
            ...
            axisX.WorkdaysOptions.Workdays = Weekday.Sunday Or Weekday.Monday Or Weekday.Tuesday Or Weekday.Wednesday Or Weekday.Thursday Or Weekday.Friday
            ' Specify holidays
            axisX.WorkdaysOptions.Holidays.AddRange(New KnownDate() {New KnownDate("Custom Holiday 1", New DateTime(1994, 3, 2, 0, 0, 0, 0)), New KnownDate("Custom Holiday 2", New DateTime(1994, 4, 2, 0, 0, 0, 0))})
            ' Specify strict working days.
            ' Thay will have a priority over the holidays specified.
            axisX.WorkdaysOptions.ExactWorkdays.Add(New KnownDate("Community Work Day", New DateTime(1994, 3, 2, 0, 0, 0, 0)))
'#End Region  ' #code
        End Sub
    End Class
End Namespace
